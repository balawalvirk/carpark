...
public class Exit2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Initialised " + Exit2 + " client and IO connections");
        
        
        fromUser = stdIn.readLine();
        if (fromUser != null) {
            System.out.println(Exit2 + " sending " + fromUser + " request to CarParkServer");
            out.println(fromUser);
        }
        fromServer = in.readLine().toString();
        System.out.println(Exit2 + " received " + fromServer + " : from CarParkServer");
